...
Button.prototype.onClick = function () {
    ...
    case "Playlist":
        ...
        if (displayPlaylist) {
            // getAlbumArt();
            listOnSize();   // refreshes scroll bar
        } else {
    ...
    if (!buttonTimerStarted) {
        ...
        buttonTimer = window.SetInterval(function () {
            ...
            for (var i in activatedBtns) {
                ...
                if ((activatedBtns[i].hoverAlpha == 255 || activatedBtns[i].downAlpha == 255)) {
                ...
                alphaIsZero = (testAlpha += (activatedBtns[i].hoverAlpha + activatedBtns[i].downAlpha)) == 0;
